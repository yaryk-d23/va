...
function getFindingsAnalysisListData() {
    return $.ajax({
        ...
        url: window.SITE_LOCATION_URL + "/_api/web/lists/getbytitle('Findings Analysis')/items?$top=50000&$select=*,Business_x0020_Process_x0020_Are/Title&$expand=Business_x0020_Process_x0020_Are",
        dataType: "json",
    }).then(function (res) {
        return res.value;
    });
